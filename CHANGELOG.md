...
- Changed default `commission` from 0.001 (0.1%) to 0.0025 (0.25%) — better reflects the actual fees I pay on the exchanges I use; the 0.1% default was too optimistic for my workflow.
